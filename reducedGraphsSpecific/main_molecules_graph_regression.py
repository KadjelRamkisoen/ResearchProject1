...
def train_val_pipeline(MODEL_NAME, dataset, params, net_params, dirs):
    ...
    torch.save(model.state_dict(), MODEL_NAME + '_44_state_dict.pt')
...
def main():    
    ...
    write_file_name = out_dir + 'results/Final reduced results/result_' + MODEL_NAME + "_" + DATASET_NAME + "_GPU" + str(config['gpu']['id']) + "_" + time.strftime('%Hh%Mm%Ss_on_%b_%d_%Y')
